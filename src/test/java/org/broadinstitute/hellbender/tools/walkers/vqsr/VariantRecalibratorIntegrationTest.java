...
public class VariantRecalibrationWalkersIntegrationTest extends WalkerTest {
    ...
    //////////////////////////////////////
    VRTest gatk4ValRecal = new VRTest(
            validationDataLocation + "phase1.projectConsensus.chr20.raw.snps.vcf",
            validationDataLocation + "1kg_exomes_unfiltered.AFR.unfiltered.vcf",
            "ce4bfc6619147fe7ce1f8331bbeb86ce",  // tranches
            "5a298554e9175961f63506c4e42ea78b",  // recal file
            "f284c0cbb00407cc5273c6f1a871513e"); // cut VCF

    @DataProvider(name = "VRGATK4Test")
    public Object[][] createDataVRGATK4Test() {
        return new Object[][]{ {gatk4ValRecal} };
    }

    private String GATK4TestData = "/users/cmn/projects/hellbender/src/test/resources/org/broadinstitute/hellbender/tools/walkers/variantutils/VariantRecalibrator/";

    @Test(dataProvider = "VRGATK4Test")
    public void testGATK4VariantRecalibrator(VRTest params) {
        //System.out.printf("PARAMS FOR %s is %s%n", vcf, clusterFile);
        WalkerTest.WalkerTestSpec spec = new WalkerTest.WalkerTestSpec(
                "-R " + b37KGReference +
                        " -resource:known=true,prior=10.0 " + GATK4TestData + "dbsnp_132_b37.leftAligned.20.1M-40M.vcf" +
                        " -resource:truth=true,training=true,prior=15.0 " + GATK4TestData + "sites_r27_nr.b37_fwd.20.1M-40M.vcf" +
                        " -resource:training=true,truth=true,prior=12.0 " + GATK4TestData + "Omni25_sites_1525_samples.b37.20.1M-40M.vcf" +
                        ...
                        " -recalFile %s" +
                        " -mode SNP" +
                        " --rscript_file /users/cmn/projects/hellbender/src/test/resources/org/broadinstitute/hellbender/tools/walkers/variantutils/VariantRecalibrator/GATK3Snp20RScript.r" +
                        " -tranchesFile %s",
...
//        return new Object[][]{ {indelUnfiltered}, {indelFiltered} };
        return new Object[][]{ {indelUnfiltered} };
    }
