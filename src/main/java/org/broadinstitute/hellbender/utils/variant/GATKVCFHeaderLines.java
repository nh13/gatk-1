...
public class GATKVCFHeaderLines {
    ...
    static {
        ...
        addFormatLine(new VCFFormatHeaderLine(HAPLOTYPE_CALLER_PHASING_SET_KEY, 1, VCFHeaderLineType.Integer, "Physical phasing set information, identifying the position of the first variant in the phasing group"));
