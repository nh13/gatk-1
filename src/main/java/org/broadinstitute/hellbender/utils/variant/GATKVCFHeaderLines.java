...
public class GATKVCFHeaderLines {
    ...
    static {
        ...
        // TODO: remove this when this PR is merged https://github.com/samtools/htsjdk/pull/1200
        addFormatLine(new VCFFormatHeaderLine(VCFConstants.PHASE_SET_KEY, 1, VCFHeaderLineType.Integer, "Physical phasing set information, identifying the position of the first variant in the phasing group"));
